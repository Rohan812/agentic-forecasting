...
:mod:`~ai_stocks_forecasting.analyst_agent` module (they are just task
...
def build_starter_agent_config(
    ...
    *,
    ...
    notebook — a list of :class:`~ai_stocks_forecasting.starter_agent.tools.ToolSpec`
    from the factories in :mod:`ai_stocks_forecasting.starter_agent.tools`::

        from ai_stocks_forecasting.starter_agent import tools, build_starter_agent_config
