...
Unlike :mod:`ai_stocks_forecasting.analyst_agent`, this agent is designed as
...
Skill mutability
----------------
The ``wti-strategy`` skill is backed by a :class:`~ai_stocks_forecasting.adaptive_agent.skill_state.WtiStrategyState`
